    ...
    <div className={styles.container}>
      ...
      <ReactCardFlip isFlipped={showHowIGotStartedContent}>
        ...
        <section
          ...
          tabIndex={0}
        >
          In 2016 I decided to do something I had never done before. Out of curiosity I clicked F12
          on a web page and start editing the CSS. This lead to watching YouTube videos about this
          crazy thing called JQuery. As the summer went on I eventually took the plunge, signed up
          for a Web Development Bootcamp, and by December of that year had joined my first team.
          I&apos;ve been happily writing code ever since.
        </section>
      </ReactCardFlip>
